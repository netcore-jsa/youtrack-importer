...
public class EnumsMappingView extends AbstractCsvUniqueValueMappingView<EnumsMapping, ProjectCustomField> {
    ...
    private EnumsMapping enumsMapper;
    ...
    @Override
    EnumsMapping getEmptyMapper() {
        return new EnumsMapping();
    }
