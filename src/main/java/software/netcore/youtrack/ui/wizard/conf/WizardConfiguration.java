...
public class WizardConfiguration {
    ...
    public WizardFlow wizardFlow() {
        ...
        return new WizardFlow.WizardFlowBuilder()
                ...
                .and()
                    .step()
                        .title("YouTrack connection info")
                ...
                .and()
                    .step()
                        .title("Map mandatory fields")
                        .navigation(MandatoryFieldsMappingView.NAVIGATION)
                .and()
                    .step()
                        .title("Map users")
                ...
                .and()
                    .step()
                        .title("Import finalizing")
                        .navigation(ImportView.NAVIGATION)
                .and()
                    .storage(storage())
                .build();
        //@formatter:on
